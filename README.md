...
A progressive web app for tracking the [75 Hard challenge](https://andyfrisella.com/pages/75hard-info) — 75 consecutive days of 6 daily tasks. Miss one task and you restart from day 1.
...
- **History** — full breakdown of every past day and its tasks
